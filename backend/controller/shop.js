...
router.post("/create-shop", upload.single("file"), async (req, res, next) => {
  try {
    ...
    const activationUrl = `https://eshop-market-app.vercel.app/seller/activation/${activationToken}`;
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      if (fs.existsSync(existAvatarPath)) {
        ...
        console.log('Avatar file does not exist:', existAvatarPath);
      }
...
router.delete(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      if (seller.avatar) {
        const avatarPath = path.join(__dirname, '../uploads', seller.avatar);
